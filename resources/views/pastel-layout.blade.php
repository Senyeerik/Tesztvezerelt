...
<body>
    ...
    <nav>
        ...
        <ul id="menu">
            ...
            <li><a href="/pass-array" class="{{ Request::path() === 'pass-array' ? 'active' : '' }}">Tömb adatainak
                    küldése</a></li>
            <li><a href="/request-test?title=MyFirstTitle"
                    class="{{ Request::path() === 'request-test' ? 'active' : '' }}">Adatküldés URL segítségével</a>
            </li>
            <li><a href="/posts/elso-bejegyzes"
                    class="{{ Request::path() === 'posts/elso-bejegyzes' ? 'active' : '' }}">Első blogbejegyzés</a></li>
        </ul>
    </nav>
    <!-- // -->
    <!-- Banner -->
